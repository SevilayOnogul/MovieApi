...
{     
    ...
    public class AdminMovieController : Controller
    {
        ...
        public async Task<IActionResult> MovieList()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7270/api/Movies/GetMovieWithCategory");
        ...
        public async Task<IActionResult> CreateMovie(CreateAdminMovieDto createAdminMovieDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7270/api/Movies", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
